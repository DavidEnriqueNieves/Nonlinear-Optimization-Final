...
file_name = strcat("~/Documents/Semester10/MTH5335/Project/results(algorithm="+ options.Algorithm+ "+ iterations="+ options.MaxIterations+  "f=" + fval+ ".csv" );


results = write_results_to_csv(file_name, x, fval, x0, ub, lb, exitflag, output, lambda, grad, hessian, C2G, C5G, f_coeffs);

% Define function to write results to a CSV file
function results = write_results_to_csv(file_name, x_opt, fval, x0, ub, lb, exitflag, output, lambda, grad, hessian, C2G, C5G, f_coeffs)
